 ...
 * For blake3-optimized v1.3.0 Parallel mode (worker_threads)
 */
'use strict';

const blake3 = require('./blake3.js');

console.log('BLAKE3 Optimized v1.3.0 (Parallel) - Benchmark Suite');
console.log('=====================================================\n');
...
async function run() {
  ...
  console.log('\n' + '─'.repeat(50));
  console.log('Mode: Parallel (worker_threads + SIMD)');
}
